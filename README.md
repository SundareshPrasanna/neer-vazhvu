...
**Urban Water Intelligence** - An open-source platform that turns public water data into actionable intelligence for Indian cities. Live for Chennai, Madurai, Bengaluru, Mumbai, Delhi, Hyderabad, Kolkata and Gurugram today, with more cities on the way.
...
- **My Ward** - Per-ward report aggregating every layer above with comparison + uplift planner (Chennai, Madurai, Bengaluru, Delhi; deliberately withheld for Mumbai until the ward build lands, for Kolkata because the only public ward geometry covers 141 of 144 wards - the three missing ones are 9.2% of the city - and for Gurugram because although all 36 ward polygons are harvested, no ward-level attribute exists to attach to them, and GMDA's layer publishes a ward number and a zone code with no ward name)
