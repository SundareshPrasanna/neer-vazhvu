...
- **Allocation Ledger** (`/[cityId]/allocations`, 7 cities) - Who is owed what water: every arrangement (source → authority → recipient) with entitled vs received, the legal/administrative instrument it rests on, and a confidence grade - including the honest "unreported" class for quotas whose deliveries nobody publishes. Kolkata inverts the shape: it holds no entitlement for its own water, abstracting run-of-river from the Hooghly, so what the ledger records is what KMC sells onward
- **Commitments Register** (`/[cityId]/commitments`, 7 cities) - 82 dated commitments by named institutions (commissioning dates, court deadlines, mitigation claims) checked against time; statuses change only with a dated citation and history appends, never overwrites
...
| [Erode](https://neervazhvu.org/atlas/tn/erode) | TN | 225 | 14 | Canal country on the Bhavani: 39% of irrigation is canal water, Nambiyur taluk pumps 171% of its recharge |
| [Namakkal](https://neervazhvu.org/atlas/tn/namakkal) | TN | 322 | 15 | Cauvery bank with almost no canal: 72% of irrigation is open wells, 5 of 8 taluks over-exploited |
| [Karur](https://neervazhvu.org/atlas/tn/karur) | TN | 157 | 8 | Where the Amaravathi meets the Cauvery: 4 of 7 taluks over-exploited and 3 critical, 84% of irrigation from wells |
| [Tiruppur](https://neervazhvu.org/atlas/tn/tiruppur) | TN | 265 | 13 | The Noyyal's dyeing belt: 22% canal water, 77% wells, Palladam taluk at 121% of recharge |
| [Vellore](https://neervazhvu.org/atlas/tn/vellore) | TN | 247 | 7 | The Palar's fort town with no canal and no tank irrigation: 5 of 6 taluks over-exploited, K.V. Kuppam at 151% of recharge |
| [Ranipet](https://neervazhvu.org/atlas/tn/ranipet) | TN | 288 | 7 | The Palar below Vellore with no canal: 96% of irrigation from wells, Arcot taluk over-exploited at 113% |
| [Dindigul](https://neervazhvu.org/atlas/tn/dindigul) | TN | 306 | 14 | Under the Palani hills: 7 of 10 taluks over-exploited, Gujiliamparai at 159% of recharge, 73% of irrigation from open wells |
| [Tiruvallur](https://neervazhvu.org/atlas/tn/tiruvallur) | TN | 526 | 14 | North of Chennai with no canal irrigation: 80% on tube and bore wells, 6 of 9 taluks safe, Avadi highest at 83% |
| [Krishnagiri](https://neervazhvu.org/atlas/tn/krishnagiri) | TN | 333 | 10 | Hosur's district on the Thenpennai: 3 of 8 taluks over-exploited, Uthangarai at 149%, Hosur taluk critical at 90%, 89% of irrigation from wells |
| [Satara](https://neervazhvu.org/atlas/mh/satara) | MH | 1,502 | 11 | Koyna country with a dry eastern edge |
| [Kolar](https://neervazhvu.org/atlas/ka/kolar) | KA | 154 | 6 | Tank country east of Bengaluru: all 6 taluks draw more groundwater than recharges, Mulabagilu at 213%, 99.6% of drinking-water sources on groundwater |

Two identity adapters exist - Tamil Nadu's register adapter (TNRD directory, JJM Citizen Corner, Census 2011 DCHB, TNGIS boundaries, IN-GRES taluks, Season and Crop Report irrigation) and the LGD adapter that onboarded Maharashtra (LGD catalog on data.gov.in, DataMeet village polygons, First Census of Water Bodies, MPCB District Environment Plan) - so a new district on an existing adapter is roughly a day of register fetches plus human review of the staged name-resolution proposals. District verdicts are composed, never scored: the severest present reading leads and unmeasured dimensions are named on the page. A monthly GitHub Actions run ([.github/workflows/atlas-refresh.yml](.github/workflows/atlas-refresh.yml)) re-fetches registers whose upstream editions moved. Adding a district, step by step: [docs/methodology/add-a-district.md](docs/methodology/add-a-district.md).
