...
- **My Ward** - Per-ward report aggregating every layer above with comparison + uplift planner; Mumbai's opens with a ward water-equity panel (supply hours / unfit samples / unmetered share, ranked worst-first from Praja's RTI tables)
