...
| Why it wins | Hosted at IIT Hyderabad → **outside NICNET**, reachable from any network (unlike WRIS/CGWA); every assessment year; every admin level (country → state → district → tehsil/block/mandal/taluk/firka); GIS layers included |
