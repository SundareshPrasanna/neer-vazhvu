...
**473 artifacts: L0: 473 · L1: 355 · L2: 36 · L3: 7**

| family | files | ≥L1 | ≥L2 | L3 |
|---|--:|--:|--:|--:|
| basins | 92 | 4 | 0 | 0 |
| cascade | 48 | 48 | 10 | 0 |
| data-root | 111 | 94 | 21 | 5 |
| geojson-layers | 94 | 81 | 5 | 2 |
| ingres | 1 | 1 | 0 | 0 |
| rich-bodies | 127 | 127 | 0 | 0 |

## Enveloped artifacts (≥L2): 36
...
- L2 `public/data/commitments-madurai.json` - L3 fail: top-level key 'headline' is not envelope, GeoJSON, contract-declared, or grandfathered legacy - per-scope additions must live in ext (spec 6.3)
