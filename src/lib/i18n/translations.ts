...
export const translations: Record<string, { en: string; ta: string }> = {
  ...
  "wb_panel.satellite_observed":   { en: "Observed from satellite data through {date} ({confidence}).", ta: "{date} வரை செயற்கைக்கோள் தரவில் இருந்து கணிக்கப்பட்டது ({confidence})." },
