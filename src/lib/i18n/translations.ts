...
export const translations: Record<string, { en: string; ta: string }> = {
  ...
  "supply_overview.zones_label":        { en: "Zones",                   ta: "மண்டலங்கள்" },
  "supply_overview.zones_sub":          { en: "distribution",            ta: "விநியோகம்" },
  "supply_overview.mains_label":        { en: "Mains",                   ta: "முக்கிய குழாய்கள்" },
  "supply_overview.connections_line":   { en: "{total} connections: {domestic} domestic · {commercial} commercial · {industrial} industrial", ta: "{total} இணைப்புகள்: {domestic} வீட்டுவசதி · {commercial} வணிக · {industrial} தொழில்துறை" },
