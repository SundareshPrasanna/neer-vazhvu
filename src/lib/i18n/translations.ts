...
export const translations: Record<string, { en: string; ta: string }> = {
  ...
  "report.metric_wb_health_desc":  { en: "Average restoration priority score across all assessed water bodies in this ward (scale: 19-82). Lower score = healthier water bodies. Ranked only among wards with assessed water bodies.", ta: "இந்த வார்டில் மதிப்பீடு செய்யப்பட்ட அனைத்து நீர்நிலைகளின் சராசரி மறுசீரமைப்பு முன்னுரிமை மதிப்பெண் (அளவு: 19-82). குறைந்த மதிப்பெண் = ஆரோக்கியமான நீர்நிலைகள்." },
  "report.metric_wb_density":      { en: "Water body presence",               ta: "நீர்நிலை இருப்பு" },
  "report.metric_wb_density_desc": { en: "Number of existing water bodies per sq km of ward area. Wards with more natural water infrastructure per unit area score higher. Applies to all 200 wards - wards with zero water bodies score 0.", ta: "வார்டு பரப்பளவின் ஒரு சதுர கி.மீ.க்கு தற்போதுள்ள நீர்நிலைகளின் எண்ணிக்கை. அனைத்து 200 வார்டுகளுக்கும் பொருந்தும்." },
  "report.metric_flood_severe":    { en: "Flood risk exposure",               ta: "வெள்ள ஆபத்து வெளிப்பாடு" },
  "report.metric_flood_severe_desc": { en: "Number of high/very high risk flood hazard zones per sq km. Measures actual flood risk density, not just the proportion. Lower = less flood exposure. Ranked only among wards with mapped flood data.", ta: "ஒரு சதுர கி.மீ.க்கு உயர்/மிக உயர் ஆபத்து வெள்ள மண்டலங்களின் எண்ணிக்கை. உண்மையான வெள்ள ஆபத்து அடர்த்தியை அளவிடுகிறது." },
  "report.metric_drainage":        { en: "Drainage coverage",                 ta: "வடிகால் கவரேஜ்" },
  "report.metric_drainage_desc":   { en: "Mapped drainage lines per sq km. Higher density = better stormwater drainage coverage. Note: measures mapped infrastructure presence, not condition or capacity.", ta: "ஒரு சதுர கி.மீ.க்கு வரைபடப்படுத்தப்பட்ட வடிகால் பாதைகள். அதிக அடர்த்தி = சிறந்த வடிகால் கவரேஜ். குறிப்பு: உள்கட்டமைப்பு இருப்பை அளவிடுகிறது, நிலையை அல்ல." },
  "report.metric_sewerage":        { en: "Sewage infra coverage",             ta: "கழிவுநீர் உள்கட்டமைப்பு கவரேஜ்" },
  "report.metric_sewerage_desc":   { en: "Sewage pumping stations and mains per sq km. Higher density = better sewage network coverage. Note: measures mapped infrastructure presence, not condition or capacity.", ta: "ஒரு சதுர கி.மீ.க்கு கழிவுநீர் பம்பிங் நிலையங்கள் மற்றும் குழாய்கள். அதிக அடர்த்தி = சிறந்த கழிவுநீர் நெட்வொர்க். குறிப்பு: இருப்பை அளவிடுகிறது, நிலையை அல்ல." },
  ...
  "report.grade_legend":           { en: "Grading scale (percentile rank among 200 Chennai wards):", ta: "தரமிடல் அளவுகோல் (200 சென்னை வார்டுகளில் சதவீத தரவரிசை):" },
  "report.ranking_note":           { en: "Rankings compare all 200 Chennai wards using static spatial data. Groundwater (live data) is not included in rankings.", ta: "தரவரிசைகள் நிலையான இடஞ்சார் தரவைப் பயன்படுத்தி அனைத்து 200 சென்னை வார்டுகளையும் ஒப்பிடுகின்றன. நிலத்தடி நீர் (நேரடி தரவு) தரவரிசையில் சேர்க்கப்படவில்லை." },
  "report.methodology":            { en: "Methodology", ta: "முறையியல்" },
  "report.methodology_body":       { en: "This report card grades wards on 5 metrics using percentile ranking. All density metrics (per sq km) are normalized by ward polygon area computed from GCC 2022 ward boundaries. Zone/city comparisons use median (not mean) to resist outlier distortion from very small or large wards. Grades: A = top 20%, B = 21-40%, C = 41-60%, D = 61-80%, F = bottom 20%. The overall grade is a weighted composite of individual metric percentiles.", ta: "இந்த அறிக்கை அட்டை 5 அளவீடுகளைப் பயன்படுத்தி சதவீத தரவரிசையில் வார்டுகளை தரமிடுகிறது. அனைத்து அடர்த்தி அளவீடுகளும் (ஒரு சதுர கி.மீ.க்கு) GCC 2022 வார்டு எல்லைகளிலிருந்து கணக்கிடப்பட்ட வார்டு பரப்பளவால் இயல்பாக்கப்படுகின்றன." },
  "report.limitations":            { en: "Known limitations", ta: "அறியப்பட்ட வரம்புகள்" },
  "report.limitations_body":       { en: "1. Infrastructure metrics measure mapped presence, not condition or maintenance quality. 2. GIS mapping coverage may vary across wards - unmapped infrastructure is not counted. 3. No population data available for demand-side normalization. 4. Flood hazard data is a snapshot - not real-time. 5. Water body restoration scores are based on satellite and survey data, not field verification.", ta: "1. உள்கட்டமைப்பு அளவீடுகள் வரைபடப்படுத்தப்பட்ட இருப்பை அளவிடுகின்றன, நிலை அல்லது பராமரிப்பு தரத்தை அல்ல. 2. GIS வரைபட கவரேஜ் வார்டுகளுக்கு இடையே வேறுபடலாம். 3. தேவை அடிப்படையிலான இயல்பாக்கத்திற்கு மக்கள்தொகை தரவு கிடைக்கவில்லை. 4. வெள்ள ஆபத்து தரவு ஒரு நிலைப்படம் - நிகழ்நேரம் அல்ல. 5. நீர்நிலை மறுசீரமைப்பு மதிப்பெண்கள் செயற்கைக்கோள் மற்றும் கணக்கெடுப்பு தரவை அடிப்படையாகக் கொண்டவை." },
