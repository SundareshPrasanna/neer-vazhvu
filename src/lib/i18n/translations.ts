...
export const translations: Record<string, { en: string; ta: string }> = {
  ...
  "wb_panel.satellite_summary_lower": { en: "Visible spread is about {observed} versus a usual seasonal footprint of {baseline} ({delta} below usual).", ta: "காணக்கூடிய நீர்ப்பரப்பு சுமார் {observed}; இந்த பருவத்தில் வழக்கமான {baseline} பரப்புடன் ஒப்பிடும்போது {delta} குறைவாக உள்ளது." },
  "wb_panel.satellite_summary_near_normal": { en: "Visible spread is about {observed}, close to the usual seasonal footprint of {baseline}.", ta: "காணக்கூடிய நீர்ப்பரப்பு சுமார் {observed}; இந்த பருவத்தின் வழக்கமான {baseline} பரப்பிற்கு அருகில் உள்ளது." },
  "wb_panel.satellite_summary_higher": { en: "Visible spread is about {observed} versus a usual seasonal footprint of {baseline} ({delta} above usual).", ta: "காணக்கூடிய நீர்ப்பரப்பு சுமார் {observed}; இந்த பருவத்தின் வழக்கமான {baseline} பரப்புடன் ஒப்பிடும்போது {delta} அதிகமாக உள்ளது." },
  "wb_panel.satellite_metric_current": { en: "Current visible spread", ta: "தற்போதைய காணக்கூடிய பரப்பு" },
  ...
  "wb_panel.satellite_compare_title": { en: "Current vs usual", ta: "தற்போது vs வழக்கம்" },
  "wb_panel.satellite_compare_current": { en: "Current", ta: "தற்போது" },
  ...
  "wb_panel.satellite_coverage_detail": { en: "{pct}% of the water body was usable in the latest satellite view", ta: "சமீபத்திய செயற்கைக்கோள் காட்சியில் நீர்நிலையின் {pct}% பகுதி பயன்படுத்தக்கூடியதாக இருந்தது" },
  ...
  "wb_panel.satellite_observed":   { en: "Observed from {source} through {date} ({confidence}).", ta: "{source} மூலம் {date} வரை கணிக்கப்பட்டது ({confidence})." },
