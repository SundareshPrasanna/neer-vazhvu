...
export const MUMBAI: CityConfig = {
  ...
  // Lake positions are OpenStreetMap: the reservoir polygon's centroid for six
  // of the seven, the dam itself (way 801753320) for Middle Vaitarna, whose
  // reservoir OSM does not map as water. The earlier hand-placed values put
  // Middle Vaitarna 14 km north of its dam and Modak Sagar 18 km west of its
  // lake - harmless on the city map, which draws the lakes as source cards,
  // but wrong for anything that reads these fields as positions.
  waterSources: [
    {
      sourceCode: 'bhatsa',
      displayName: 'Bhatsa',
