...
export const CAUVERY_TN: BasinManifest = {
  ...
  layers: [
    ...
    { family: "wq-stations", label: "Water-quality stations (TNPCB, 2023)", floor: "monitoring", geom: "point", color: "#059669", defaultOn: false },
  ],
  subBasins: [
    ...
    { key: "114", name: "Upper Bhavani", scoreboardKey: "114", areaKm2: 1807, depthLevel: 2, blurb: "Holds CPCB's Bhavani polluted location at Sirumugai (Priority V). TNPCB's own 2023 readings are a good-news story: all three stations here ran Class A-B all year. Restoration accountability is tracked below - the Bhavani improved, but which of the Rs 428 crore of committed works exist is unverifiable in public records.", unlocks: ["Station readings end at December 2023 - TNPCB stopped publishing the stretch-wise series"] },
    { key: "120", name: "Lower Bhavani", scoreboardKey: "120", areaKm2: 2403, depthLevel: 2, blurb: "Bhavanisagar to the Cauvery confluence at Bhavani. Both TNPCB stations here (Bhavani town, Sathyamangalam) ran Class A through 2023.", unlocks: ["Station readings end at December 2023 - TNPCB stopped publishing the stretch-wise series"] },
    ...
    { key: "113", name: "Amaravathi", scoreboardKey: "113", areaKm2: 9254, depthLevel: 1, blurb: "The basin's largest TN sub-basin, from the Anaimalais through Karur - and its densest dam country: 10 WRD reservoirs including the Amaravathi dam itself.", unlocks: ["The Amaravathi river itself has no station in TNPCB's stretch series - the one station in this sub-basin (Pugalur) sits on the Cauvery mainstem near the confluence", "CPCB's 2022 assessment listed an Amaravathi polluted stretch (along Madathukkulam and Karur, Priority V) - it is absent from the October 2025 report, which names only the 9 non-complying rivers of 13 monitored. Whether it recovered or stopped being monitored is not public"] },
    { key: "112", name: "Ayiaar", scoreboardKey: "112", areaKm2: 1327, depthLevel: 1, unlocks: ["Station readings end at December 2023 - TNPCB stopped publishing the stretch-wise series"] },
    ...
    { key: "128", name: "Pungar (upper Coleroon)", scoreboardKey: "128", areaKm2: 1309, depthLevel: 1, unlocks: ["Station readings end at December 2023 - TNPCB stopped publishing the stretch-wise series"] },
    { key: "119", name: "Ponnaniyar", scoreboardKey: "119", areaKm2: 1799, depthLevel: 1, unlocks: ["Station readings end at December 2023 - TNPCB stopped publishing the stretch-wise series"] },
    ...
    { key: "116", name: "Cauvery Delta", scoreboardKey: "116", areaKm2: 7303, depthLevel: 1, blurb: "The rice bowl - Thanjavur, Tiruvarur, Nagapattinam - where the river becomes a thousand channels.", unlocks: ["Kumbakonam and Mayiladuthurai stations have large gaps in TNPCB's 2023 series (3 and 2 monthly readings)", "Delta canal network and irrigation status are their own future story"] },
  ],
  credits: [
    ...
    "Water-quality stations: TNPCB stretch-wise monthly reports, Jan-Dec 2023 - the last year published; the series is a closed archive and the classes shown are the worst monthly use-based (DBU) class of 2023. Station points are town centroids (no official coordinates published); 4 of 19 mainstem stations could not be located confidently and are omitted.",
    "Restoration accountability (Sarabanga, Thirumanimutharu): TNPCB action plans + NGT case records + TNPCB water-quality series; Tamil Nadu publishes no stretch-wise progress reports.",
  ],
};
