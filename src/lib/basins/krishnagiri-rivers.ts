...
export const KRISHNAGIRI_RIVERS: BasinManifest = {
  ...
  rivers: [
    {
      ...
      attributes: {
        ...
        pollutedStretch:
          "Not in CPCB's October 2025 list for Tamil Nadu. The district's Environmental Plan (2019) records that the river enters the district 'carrying sewage from Bangalore city', that Tamil Nadu's suit O.S. No. 2/2015 against Karnataka is pending in the Supreme Court, and that CPCB, KSPCB and TNPCB have sampled the river jointly every month since September 2017 under the Court's order of 7.7.2017 (pp.18-19); TNPCB samples it monthly at Sokkarasanapalli (p.20). NGT (Southern Zone) O.A. 111/2020 concerns 'Frothing of Chemical Foam in River Thenpennai' (joint committee report, cover). TNPCB's sensor station below the Kelavarapalli dam read a monthly mean BOD of 26.1 mg/L in September 2026, against the 3 mg/L bathing criterion.",
  ...
  credits: [
    ...
    "Polluted stretch: CPCB's October 2025 list carries no Thenpennai stretch in Tamil Nadu, so no stretch is drawn. The river's pollution record is on the river card, from the district's Environmental Plan and the documents it cites.",
