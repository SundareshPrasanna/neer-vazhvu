...
export const KRISHNAGIRI_RIVERS: BasinManifest = {
  ...
  rivers: [
    {
      ...
      attributes: {
        ...
        pollutedStretch:
          "The listed stretch stops at the state line, not at the pollution. CPCB's October 2025 list carries no Tamil Nadu stretch on this river, but lists it under Karnataka as Priority I, the worst class: 'RIVER DAKSHINA PINAKINI/ THENPENNAIYAR FORM THENNPENNIYAR MUGALUR BRIDGE TO CHOKKARASANAHALLI BRIDGE' (p.14 of the printed report). Chokkarasanahalli bridge is where the river crosses into Hosur taluk. On the 2022-23 basis CPCB records a maximum BOD of 146 mg/L at Mugalur bridge in Bengaluru and 89 mg/L at the Chokkarasanahalli bridge station; its 2024 readings for the same two stations are 71 and 52.4 mg/L (Annexures III B and XIV). Downstream in Tamil Nadu, TNPCB's sensor below the Kelavarapalli dam read a monthly mean BOD of 26.1 mg/L in September 2026, against the 3 mg/L bathing criterion. The district's Environmental Plan (2019) records the river entering 'carrying sewage from Bangalore city', Tamil Nadu's suit O.S. No. 2/2015 against Karnataka pending in the Supreme Court, and monthly joint sampling by CPCB, KSPCB and TNPCB since September 2017 under the Court's order of 7.7.2017 (pp.18-19), with TNPCB sampling monthly at Sokkarasanapalli (p.20). NGT (Southern Zone) O.A. 111/2020 concerns 'Frothing of Chemical Foam in River Thenpennai'. Its joint committee, with CPCB Bangalore as nodal agency, sampled twelve points on 9 and 10 September 2020 and found the Tamil Nadu reach at class E of the Designated Best Use criteria, with 'deteriorated Dissolved Oxygen in the river stretches from Channasandra bridge to Bagalur bridge' (p.43 of the printed report). It attributes the frothing to overflow from Bellandur and Varthur lakes 'carrying domestic sewage of Koramangala & Challaghatta and Hebbal valleys of Bangalore', and records BWSSB's account of 300 MLD of treated and 258 MLD of untreated Bangalore sewage reaching the river. Surfactants, the signature of foam, were below detection at every point except Sokkarasanapalli and Bagalur bridge, the first two inside Tamil Nadu (0.34 and 0.43 mg/L anionic surfactant). The committee also recorded that the water at Samethanahalli, Mugalur, Sokkarasanapalli, Kodiyalam, Bagalur and Kelavarapalli 'is being pumped and used for agriculture in the nearby fields/farms', 'as it is also being used for edible food crops' (p.44). The committee's coordinate table places several of these points against its own stated flow order, so none is drawn on the map.",
  ...
  credits: [
    ...
    "Reservoirs: TN WRD's register on TNGIS, six waterspreads on or inside the district line (Krishnagiri, Kelavarapalli, Pambar and Shoolagiri Chinnar in the district; Chinnar and Kesarigullihalla on the Dharmapuri side). "+ "Today's storage for Krishnagiri, Kelavarapalli and Pambar comes from the state's daily reservoir dashboard, relayed by RIMES on a beta host: depth in feet, storage in Mcft and percentage of capacity, as it prints them. "+ "Its full-capacity figures agree with the Krishnagiri collectorate's own agriculture page, which is how these are confirmed to be the same dams. "+ "The dashboard states no licence of any kind, and it is a relay rather than the issuing department. It publishes a reading for the day, not a series, so no reservoir carries a chart: CWC, which does publish series, reports none of these dams. Shoolagiri Chinnar is on neither.",
