  ...
  subBasins: [
    {
      ...
      unlocks: [
        "L1: ingest sub-basin hydrology layers (streams, tank detail) from KWRIS",
        "L2: KSPCB station readings + CWC gauge series for the reach",
      ],
    },
    {
      key: "C2",
      ...
      unlocks: [
        "L1: hydrology layers from KWRIS",
    ...
    },
    {
      ...
      areaKm2: 1303,
      depthLevel: 0,
      unlocks: ["L1: hydrology layers from KWRIS"],
    },
    {
      key: "C4",
      name: "Shimsha",
    ...
    },
    {
      ...
      areaKm2: 2045,
      depthLevel: 0,
      unlocks: ["L1: hydrology layers from KWRIS", "L0 gap: no KSPCB WQ station reported in-basin"],
    },
    {
      key: "C8",
      name: "Chinnar",
