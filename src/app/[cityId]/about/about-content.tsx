...
const MumbaiPageDescriptions = dynamic(() =>
  import("./mumbai-page-descriptions").then((mod) => mod.MumbaiPageDescriptions),
);
const DelhiPageDescriptions = dynamic(() =>
  import("./delhi-page-descriptions").then((mod) => mod.DelhiPageDescriptions),
);

const HyderabadPageDescriptions = dynamic(() =>
...
const GurugramPageDescriptions = dynamic(() =>
  import("./gurugram-page-descriptions").then((mod) => mod.GurugramPageDescriptions),
);
...
export function CityAboutContent({
  ...
  const isMumbai = config.cityId === "mumbai";
  ...
  const isGurugram = config.cityId === "gurugram";
    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="space-y-3">
        ...
        <Section id="pages" title={`${t("about.section_what_each_page")} ${cityName}`}>
          ...
          {!isMadurai && !isBangalore && !isMumbai && !isChennai && !isDelhi && !isHyderabad && !isKolkata && !isGurugram && !isPune && !isSurat && (
            <p className="text-slate-600 dark:text-slate-400">
